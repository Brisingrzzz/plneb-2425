...
def delete_conceito(designacao):
    ...
    return {"success": False, "message": "Conceito apagado com sucesso!", "redirect_url": "/conceitos", "data": designacao}

@app.get("/conceitos/tabela")
def conceitos_tabela():
    conceitos = db.items()
    return render_template("table.html", conceitos=conceitos, title="Tabela de Conceitos")
